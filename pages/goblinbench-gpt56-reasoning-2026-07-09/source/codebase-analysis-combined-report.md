...
*Generated: 2026-07-09T23:40:50.093618*
*Gold issues: 12*
...
| Gold Issue | Severity | qwen-max | deepseek-flash | deepseek-pro | glm-5.2 | longcat-2.0 | grok-4.5 | kimi-code | gpt-5.5-test-only | mimo-pro | gpt-5.6-terra-test-only-reasoning-medium | gpt-5.6-terra-test-only-reasoning-high | gpt-5.6-luna-test-only-reasoning-medium | gpt-5.6-luna-test-only-reasoning-high | gpt-5.6-sol-test-only-reasoning-medium | gpt-5.6-sol-test-only-reasoning-high |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
