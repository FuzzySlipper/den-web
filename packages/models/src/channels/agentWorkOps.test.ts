...
import type { AgentWorkCurrentItem, AgentWorkCurrentResponse, AgentWorkEventsResponse, ChannelActivityEvent, DirectAgentEvent } from '@den-web/api/types';
import { buildAgentWorkOpsModel } from './agentWorkOps';
...
function currentItem(overrides: Partial<AgentWorkCurrentItem>): AgentWorkCurrentItem {
  return {
    ...
    evidenceLink: '/api/v1/timeline/channels/604/items?limit=10',
    evidenceProvenance: ['agent_work_lifecycle'],
    evidenceLinks: ['/api/v1/timeline/channels/604/items?limit=10'],
    sessionId: null,
