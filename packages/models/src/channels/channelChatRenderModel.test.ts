...
import type { AgentWorkLifecycleEvent, ChannelActivityEvent, ChannelMessage } from '@den-web/api/types';
import {
...
describe('channel chat panel sizing contract', () => {
  ...
  const chCss = readFileSync(resolve(process.cwd(), 'apps/web/src/styles/features/channels.css'), 'utf8');
