import type { AgentWorkCurrentResponse, AgentWorkCurrentItem, AgentWorkEventsResponse, AgentWorkLifecycleEvent, ChannelActivityEvent, DirectAgentEvent } from '@den-web/api/types';
