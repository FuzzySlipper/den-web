import type { AgentWorkCurrentResponse, AgentWorkEventsResponse, ChannelActivityEvent, DirectAgentEvent } from '@den-web/api/types';
import { formatTimeAgo, truncate } from '@den-web/shared';
import { buildAgentWorkOpsModel } from '@den-web/models/channels/agentWorkOps';
