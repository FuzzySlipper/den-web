...
import type { AssignmentTraceResponse, ChannelActivityEvent, ChannelMessage } from '@den-web/api/types';
import { getAssignmentTrace } from '@den-web/api/client';
...
import {
  ...
  buildTraceSummary,
} from '@den-web/models/agents/assignmentTrace';
