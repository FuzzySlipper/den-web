...
import type { WorkerPoolLobbyPresence, WorkerPoolMemberPresence } from '@den-web/api/types';
import { getWorkerPoolLobbyPresence } from '@den-web/api/client';
...
import {
  ...
  buildLobbySummary,
  formatObservedAt,
} from '@den-web/models/agents/workerPool';
