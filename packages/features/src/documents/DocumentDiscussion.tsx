...
import type { DocumentSummary, DiscussionComment } from '@den-web/api/types';
import { getDocumentDiscussion, postDocumentDiscussionComment } from '@den-web/api/client';
