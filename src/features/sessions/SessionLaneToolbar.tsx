import type { ActiveWorkRoute } from '../../api/types';
import { channelLabel } from '../channels/channelChatDisplay';
import { activeOwnerLabel, activeRouteKey, activeWorkTargetLabel } from './sessionPolicy';
import type { FocusedLaneState, FocusedSessionLane } from './sessionDisplayModel';
