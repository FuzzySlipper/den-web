...
import type { Channel, ChannelActivityEvent, ChannelMessage, ChannelReactionSummary } from '../../api/types';
import { formatTimeAgo } from '../../utils';
import { isSharedProjectChannel, messageProjectAttribution } from './channelRouting';
import { channelMessagePrimaryBody, directAgentMessageDisplay, deriveAssignmentBadge } from './channelChatRenderModel';
import { messageSender } from './channelChatDisplay';
